return {
	...
	ft = { "php", "blade" },
	cond = function()
		-- only activate if artisan exists (i.e. it's a Laravel project)
	...
	opts = {
		environments = {
			docker_ems = {
				commands = {
					php = { "docker", "compose", "exec", "ems-web", "php" },
					artisan = { "docker", "compose", "exec", "ems-web", "php", "artisan" },
					composer = { "docker", "compose", "exec", "ems-web", "composer" },
				},
			},
		},
		features = {
